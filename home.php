...
<body>
  <!-- navbar start -->
  <nav class="bg-white border-gray-200 dark:bg-gray-900 fixed top-0 left-0 w-full z-20">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="login.html" class="flex items-center space-x-3 rtl:space-x-reverse">
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Anyserv</span>
    </a>
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        <a href="#CTA" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Give Feedback/Report Here</a>
  ...
  <section class="text-gray-600 body-font">
    <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col" bis_skin_checked="1">
      <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 object-cover object-center rounded" alt="hero" src="photos/herophoto.jpg">
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto" bis_skin_checked="1">
    ...
    <div class="flex flex-wrap -m-4 text-center" bis_skin_checked="1">
      <div class="p-4 md:w-1/4 sm:w-1/2 w-full" bis_skin_checked="1">
        <div class="border-2 border-gray-200 px-4 py-6 rounded-lg" bis_skin_checked="1">
...
<!-- statistic section end -->
  ...
  <!-- CTA section start -->
  <section class="text-gray-600 body-font relative" id="CTA">
